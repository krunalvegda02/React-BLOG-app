...
<Controller
        ...
        render={({ field: { onChange } }) => {
          return (
            <Editor
              apiKey='qfsu1ejodzhnk8nfyqi3n2nln4aagryfbnl5d48ae7s6rllq'
              ...
              init={
                ...
                toolbar: "undo redo | block | image | forecolor | formatselect | bold italic | underline |  alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | removeformate| help",
